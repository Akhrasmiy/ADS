...
const Adminuserresponse = () => {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`${process.env.REACT_APP_URL}/responseStatus`, {
        headers: {
  ...
  const handleSubmit = (event) => {
    ...
    axios
      .put(
        `${process.env.REACT_APP_URL}/responseStatus/done/${row.id}`,
  ...
  const handleSubmit2 = () => {
    axios
      .delete(`${process.env.REACT_APP_URL}/responseStatus/cancel/${row.id}`, {
        headers: {
          Authorization: localStorage.getItem("token"),
        },
      })
      ...
      >
        ...
        <Box sx={style} component="form" onSubmit={handleSubmit} noValidate>
          <Grid container spacing={2}>
            ...
            <div>
              <Link
                href={`${process.env.REACT_APP_URL}/responseStatus/img/${row.id}`}
              >
                screenshot
              </Link>
            </div>
